const arbeidstidEnkeltdagFormMessages = {
    nb: {
        ...
        'arbeidstidEnkeltdagForm.validation.tid.timeHasNoValue': 'Du må fylle ut timer og minutter.',
        'arbeidstidEnkeltdagForm.validation.tid.hoursAreInvalid': 'Antall timer er ikke et gyldig tall.',
        'arbeidstidEnkeltdagForm.validation.tid.hoursAreNegative': 'Antall timer kan ikke være et negativt tall.',
        'arbeidstidEnkeltdagForm.validation.tid.minutesAreInvalid': 'Antall minutter er ikke et gyldig tall.',
        'arbeidstidEnkeltdagForm.validation.tid.minutesAreNegative': 'Antall minutter kan ikke være et negativt tall.',
        'arbeidstidEnkeltdagForm.validation.tid.tooManyHours': 'Antall timer kan ikke overstige 24 timer.',
        'arbeidstidEnkeltdagForm.validation.tid.tooManyMinutes': 'Antall minutter kan ikke overstige 59 minutter.',
        'arbeidstidEnkeltdagForm.validation.tid.durationIsTooLong':
            'Antall timer og minutter registrert er for høyt. Tiden kan ikke overstige 24 timer.',
        'arbeidstidEnkeltdagForm.validation.tid.durationIsTooShort':
            'Antall timer og minutter kan ikke være mindre enn 0 timer og 0 minutter.',
    },
};
